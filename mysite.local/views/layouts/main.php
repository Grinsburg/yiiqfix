...
<html>
  ...
  <body>
    <nav role="navigation" id="mainNaw" class="navbar">
      <div class="container-fliud"></div>

        <div class="navbar-header">
          <p class="namepr">Q<span class="log">Fix</span></p>      
        </div>
        <li class="log_in"><a class="text_a" id="" href="#modal">Войти</a></li>
        <li class="signup"><a class="text_a" href="#register">Регистрация</a></li> 
        <li class="search_p"><a class="text_a" href="#search_sto">Поиск</a></li>  
    </nav> 
    <header class="hdr1"> 
